[![Build Status](https://travis-ci.com/missating/friday-code-challenge.svg?token=MXmRqCJzfxyci1hMcQns&branch=master)](https://travis-ci.com/missating/friday-code-challenge)
